      ...
      <main className="mx-auto max-w-7xl px-6 py-4">
        ...
        <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
          <h1 className="text-sm font-medium text-muted-foreground sm:text-base">
            BL耳パラ | BL同人ASMR・BL同人音声の厳選レビューサイト
          </h1>
        ...
        {isLoveculCampaignActive() && (
          <CampaignBanner
            ...
            gradientClass="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500"
            badge="🌸 期間限定 〜5/18 11:59"
            title="春のらぶカルフェス BL 50%OFFクーポン"
            description="初回購入限定・先着・割引上限1,500円"
            ctaLabel="クーポンを見る →"
            endDate={LOVECUL_END}
          />
        )}
