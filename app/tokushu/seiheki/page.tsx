...
export const metadata: Metadata = {
  title: "人気ジャンル・性癖特集一覧 - おすすめBL作品厳選 | みみぱら",
  description:
    "人気ジャンル・性癖別のBL ASMR＆ゲーム作品特集一覧。ラブラブ、オメガバース、ツンデレなど、好みのジャンルからおすすめ作品を厳選して紹介。",
  openGraph: {
    title: "人気ジャンル・性癖特集一覧 - おすすめBL作品厳選 | みみぱら",
    description:
      "人気ジャンル・性癖別のBL ASMR＆ゲーム作品特集一覧。ラブラブ、オメガバース、ツンデレなど、好みのジャンルからおすすめ作品を厳選して紹介。",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-4">
        <Breadcrumb
          items={[{ label: "トップ", href: "/" }, { label: "ジャンル特集一覧" }]}
        />
        ...
        <div className="mb-6 mt-4">
          ...
          <div className="p-4 bg-linear-to-r from-primary/10 to-accent/10 rounded-lg border border-primary/20">
            ...
            <p className="text-sm text-foreground">
              人気ジャンル・性癖ごとに厳選したおすすめBL作品を紹介。
              <br />
              好みのジャンルをタップして、おすすめ作品をチェック！
            </p>
          </div>
        </div>
