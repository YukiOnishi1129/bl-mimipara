  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-7xl px-6 py-4">
        {/* 春のらぶカルフェス BL 50%OFFクーポンバナー（〜2026/05/18 11:59まで） */}
        {isLoveculCampaignActive() && (
          <a
            href={getLoveculCampaignAffiliateUrl()}
            target="_blank"
            rel="noopener noreferrer"
            className="mb-4 flex items-center justify-between gap-3 rounded-lg bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 p-4 text-white shadow-lg transition-transform hover:scale-[1.01]"
          >
            <div className="flex flex-col">
              ...
              <span className="text-lg font-black tracking-wide md:text-xl">
                春のらぶカルフェス BL 50%OFFクーポン
              </span>
              <span className="text-xs opacity-90">
                初回購入限定・先着・割引上限1,500円
              </span>
            </div>
