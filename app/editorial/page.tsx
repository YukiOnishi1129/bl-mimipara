...
export const metadata: Metadata = {
  title: "編集方針・運営ポリシー | BL耳パラ",
  description:
    "BL耳パラ編集部の運営方針、レビュー基準、AI活用方針、責任の所在を明示します。読者の皆さまに安心して情報をご利用いただくための編集ポリシー。",
        ...
        <div className="space-y-8 text-foreground">
          <section>
            ...
            <p className="text-muted-foreground">
              BL耳パラ（読み: ビーエル みみパラ）は、DLsite・FANZAで販売されているBL同人ASMR・BL同人音声・BL同人ゲーム作品を、独自の視点で整理・紹介する作品データベースサイトです。「迷ったらここから選べばハズレなし」を基本コンセプトに、ユーザーが膨大な作品の中から自分に合う1作品を見つけられるよう支援することを目的としています。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              本サイトは「BL耳パラ編集部」が運営する個人運営の作品レビュー・データベースサイトです。掲載するすべての記事の編集・公開判断はBL耳パラ編集部が責任を持って行っています。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2 text-muted-foreground">
              BL耳パラでは、作品の魅力をわかりやすく伝えるために、AI（大規模言語モデル）を活用したコンテンツ生成を行っています。
            </p>
            <ul className="list-inside list-disc space-y-1 text-muted-foreground">
              <li>
              ...
              <li>
                AI生成コンテンツについても、最終的な公開判断と表現の責任はBL耳パラ編集部が負います
              </li>
            </ul>
            <p className="mt-2 text-muted-foreground">
