...
import type { DbSeihekiFeature } from "@/lib/db";

interface SeihekiFeatureCarouselProps {
  seihekiFeatures: DbSeihekiFeature[];
  autoPlay?: boolean;
  interval?: number;
}
...
export function SeihekiFeatureCarousel({
  seihekiFeatures,
  autoPlay = true,
  interval = 5000,
}: SeihekiFeatureCarouselProps) {
  const items = seihekiFeatures;
...
export function SeihekiFeatureGridCarousel({
  seihekiFeatures,
  autoPlay = true,
  interval = 4000,
}: SeihekiFeatureCarouselProps) {
