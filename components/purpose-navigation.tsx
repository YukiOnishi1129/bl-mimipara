 ...
 * SEO目的: SEO Guide 2026 応用編【3】トップページ順位UP施策
 */
...
const PURPOSES: PurposeItem[] = [
  ...
  },
  {
    icon: Heart,
    label: "性癖別に探したい",
    description: "甘々・年上・独占欲等",
    href: "/tokushu/seiheki",
...
export function PurposeNavigation() {
  return (
    <section className="mb-6" aria-label="目的別の探し方">
      <h2 className="mb-3 text-base font-bold text-foreground sm:text-lg font-heading">
        🎯 何にお困りですか？目的別に探す
      </h2>
