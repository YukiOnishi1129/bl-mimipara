...
export const metadata = {
  title: "ページが見つかりません",
  description:
    "お探しのページは移動または削除された可能性があります。トップページや人気ランキング・特集ページからBL ASMR・ゲームを探してください。",
      ...
      <main className="mx-auto max-w-5xl px-4 py-12">
        ...
        <section className="mt-12">
          ...
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card className="hover:border-primary/50 transition-all">
                <CardContent className="flex items-center gap-3 p-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">人気のBL ASMR・ゲーム</div>
                  </div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/cv">
              <Card className="hover:border-violet-500/50 transition-all">
                <CardContent className="flex items-center gap-3 p-4">
                  <Mic className="h-6 w-6 text-violet-500 shrink-0" />
                  <div>
            ...
            <Link href="/tokushu/seiheki">
              <Card className="hover:border-primary/50 transition-all">
                <CardContent className="p-4">
                  ...
                  <div className="mt-1 text-xs text-muted-foreground">溺愛・幼なじみなど人気ジャンル</div>
                </CardContent>
              </Card>
            </Link>
